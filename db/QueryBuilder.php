...
use db\conditions\ConditionInterface;
use db\conditions\HashCondition;
 ...
 * ['LIKE' => db\condition\LikeCondition::class] ``` . This property is write-only.
...
class QueryBuilder extends \base\BaseObject
{
    /**
    ...
    {
        return [
            'NOT'         => 'db\conditions\NotCondition',
            'AND'         => 'db\conditions\AndCondition',
            'OR'          => 'db\conditions\OrCondition',
            'BETWEEN'     => 'db\conditions\BetweenCondition',
            'NOT BETWEEN' => 'db\conditions\BetweenCondition',
            'IN'          => 'db\conditions\InCondition',
            'NOT IN'      => 'db\conditions\InCondition',
            'LIKE'        => 'db\conditions\LikeCondition',
            'NOT LIKE'    => 'db\conditions\LikeCondition',
            'OR LIKE'     => 'db\conditions\LikeCondition',
            'OR NOT LIKE' => 'db\conditions\LikeCondition',
            'EXISTS'      => 'db\conditions\ExistsCondition',
            'NOT EXISTS'  => 'db\conditions\ExistsCondition',
        ];
    }
    ...
    {
        return [
            'db\Query'                              => 'db\QueryExpressionBuilder',
            'db\PdoValue'                           => 'db\PdoValueBuilder',
            'db\Expression'                         => 'db\ExpressionBuilder',
            'db\conditions\ConjunctionCondition'    => 'db\conditions\ConjunctionConditionBuilder',
            'db\conditions\NotCondition'            => 'db\conditions\NotConditionBuilder',
            'db\conditions\AndCondition'            => 'db\conditions\ConjunctionConditionBuilder',
            'db\conditions\OrCondition'             => 'db\conditions\ConjunctionConditionBuilder',
            'db\conditions\BetweenCondition'        => 'db\conditions\BetweenConditionBuilder',
            'db\conditions\InCondition'             => 'db\conditions\InConditionBuilder',
            'db\conditions\LikeCondition'           => 'db\conditions\LikeConditionBuilder',
            'db\conditions\ExistsCondition'         => 'db\conditions\ExistsConditionBuilder',
            'db\conditions\SimpleCondition'         => 'db\conditions\SimpleConditionBuilder',
            'db\conditions\HashCondition'           => 'db\conditions\HashConditionBuilder',
            'db\conditions\BetweenColumnsCondition' => 'db\conditions\BetweenColumnsConditionBuilder',
        ];
    }
     ...
     * to instance of [[db\condition\ConditionInterface|ConditionInterface]] according to
    ...
    public function createConditionFromArray($condition)
    {
        if (isset($condition[0])) { // operator format: operator, operand 1, operand 2, ...
            ...
            if (isset($this->conditionClasses[$operator])) {
                ...
                $className = 'db\conditions\SimpleCondition';
            }
