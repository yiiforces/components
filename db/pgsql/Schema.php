...
use db\CheckConstraint;
use db\Constraint;
use db\ConstraintFinderInterface;
use db\ConstraintFinderTrait;
use db\Expression;
use db\ForeignKeyConstraint;
use db\IndexConstraint;
use db\TableSchema;
use db\ViewFinderTrait;
...
class Schema extends \db\Schema implements ConstraintFinderInterface
{
	use ViewFinderTrait;
	...
	protected function loadTableIndexes($tableName)
	{
		static $sql = '
			...
			INNER JOIN "pg_attribute" AS "ia"   ON "ia"."attrelid" = "i"."indrelid" AND "ia"."attnum" = ANY ("i"."indkey")
