...
class QueryBuilder extends \db\QueryBuilder
{
    /**
    ...
    protected function defaultConditionClasses()
    {
        return array_merge(parent::defaultConditionClasses(), [
            'ILIKE'         => 'db\conditions\LikeCondition',
            'NOT ILIKE'     => 'db\conditions\LikeCondition',
            'OR ILIKE'      => 'db\conditions\LikeCondition',
            'OR NOT ILIKE'  => 'db\conditions\LikeCondition',
        ]);
    }
    ...
    protected function defaultExpressionBuilders()
    {
        return array_merge(parent::defaultExpressionBuilders(), [
            'db\ArrayExpression' => 'db\pgsql\ArrayExpressionBuilder',
            'db\JsonExpression'  => 'db\pgsql\JsonExpressionBuilder',
        ]);
    }
     ...
     * of [[db\Query|Query]] to perform INSERT INTO ... SELECT SQL statement.
     * Passing of [[db\Query|Query]] is available since version 2.0.11.
